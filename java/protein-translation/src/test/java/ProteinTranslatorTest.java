...
public class ProteinTranslatorTest {
    ...
    public void testMethionineRnaSequence() {
        List<String> expected = Collections.singletonList("Methionine");
        assertEquals(expected, proteinTranslator.translate("AUG"));
    }

    @Test
    public void testPhenylalanineRnaSequence1() {
        List<String> expected = Collections.singletonList("Phenylalanine");
    ...
    public void testLeucineRnaSequence1() {
        List<String> expected = Collections.singletonList("Leucine");
    ...
    public void testSerineRnaSequence1() {
        List<String> expected = Collections.singletonList("Serine");
    ...
    public void testTyrosineRnaSequence1() {
        List<String> expected = Collections.singletonList("Tyrosine");
    ...
    public void testCysteineRnaSequence1() {
        List<String> expected = Collections.singletonList("Cysteine");
    ...
    public void testTryptophanRnaSequence1() {
        List<String> expected = Collections.singletonList("Tryptophan");
